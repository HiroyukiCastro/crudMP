...
<head>
    ...
    <title>GENERADOR DE CITACIONES ☺</title>
...
<body>
    ...
    <h1 class="text-center mt-5 mb-5 fw-bold">GENERADOR DE CITACIONES CSM!!!!</h1>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                <h1 class="text-center">
                    ...
                    GENERADOR DE CITACIONES ☺ - HAY (<?php echo $totalEmpleados ?>) HECHAS 
