  ...
  try {
    ...
    if (response.status === 200) {
      ...
      tr.innerHTML = `
        ...
        <td>${infoEmpleado.carpeta}</td>
        <td>${infoEmpleado.citado}</td>
        <td>${infoEmpleado.direccion}</td>
        <td>${infoEmpleado.investigado}</td>
        <td>${infoEmpleado.delito}</td>
        <td>${infoEmpleado.agraviado}</td>
        <td>${infoEmpleado.disposicion}</td>
        <td>${infoEmpleado.disposicionnumero}</td>
