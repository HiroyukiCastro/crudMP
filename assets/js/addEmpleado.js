  ...
  try {
    ...
    if (response.status === 200) {
      ...
      setTimeout(() => {
        ...
        toastr.success("¡La Cédula ha sido actualizada correctamente!.");
      }, 600);
    } else {
      console.error("Error al registrar la cédula cojudo!!!!");
    }
  } catch (error) {
    console.error("Error al enviar el formulario CSMMMM !!!!", error);
  }
}
